...
('3fc52835-2f3a-400d-af45-4a0a7ad7848b', 'd492e3653405f61a2d3a5662082733b5d63993ad4e65685d93697781a53bc12f', '2023-06-12 21:05:21.008', '20230612210513_ordenes', NULL, NULL, '2023-06-12 21:05:20.987', 1);
INSERT INTO `_prisma_migrations` (`id`, `checksum`, `finished_at`, `migration_name`, `logs`, `rolled_back_at`, `started_at`, `applied_steps_count`) VALUES
('5d6613c9-8c0e-4f79-a1de-e9f07c7ac991', 'ec9a5b675dd855d209c09fffe4ea363d6d442a47f419628c91285db5c3265aae', '2023-06-13 04:25:11.310', '20230613042511_estado', NULL, NULL, '2023-06-13 04:25:11.286', 1);
INSERT INTO `_prisma_migrations` (`id`, `checksum`, `finished_at`, `migration_name`, `logs`, `rolled_back_at`, `started_at`, `applied_steps_count`) VALUES
('b325bb14-01cc-46d0-8b57-85b7e5f2d39f', 'e6e8cae43b67d8bb7d10215d78afce3586b7b6ff76020b0e9e324c4770151e9d', '2023-06-12 21:05:20.959', '20230520141520_categorias_y_productos', NULL, NULL, '2023-06-12 21:05:20.880', 1);
INSERT INTO `_prisma_migrations` (`id`, `checksum`, `finished_at`, `migration_name`, `logs`, `rolled_back_at`, `started_at`, `applied_steps_count`) VALUES
('b6f52a60-87c9-4be2-b223-97495a34c345', '1b43c607aef19ffc2eb0a6c85b84e7f8ce3d535d91d5d80bd9eaf95c28739938', '2023-06-12 21:05:20.984', '20230520141842_ordenes', NULL, NULL, '2023-06-12 21:05:20.962', 1);
...
INSERT INTO `orden` (`id`, `nombre`, `total`, `pedido`, `fecha`, `estado`) VALUES
(1, 'Hernan', 339.4, '[{\"id\": 1, \"imagen\": \"cafe_01\", \"nombre\": \"Café Caramel con Chocolate\", \"precio\": 59.9, \"cantidad\": 4}, {\"id\": 2, \"imagen\": \"cafe_02\", \"nombre\": \"Café Frio con Chocolate Grande\", \"precio\": 49.9, \"cantidad\": 2}]', '1686603945211', 1);
INSERT INTO `orden` (`id`, `nombre`, `total`, `pedido`, `fecha`, `estado`) VALUES
(4, 'HERNAN ARANGO CORTES', 279.5, '[{\"id\": 1, \"imagen\": \"cafe_01\", \"nombre\": \"Café Caramel con Chocolate\", \"precio\": 59.9, \"cantidad\": 3}, {\"id\": 2, \"imagen\": \"cafe_02\", \"nombre\": \"Café Frio con Chocolate Grande\", \"precio\": 49.9, \"cantidad\": 2}]', '1686629652348', 1);
INSERT INTO `orden` (`id`, `nombre`, `total`, `pedido`, `fecha`, `estado`) VALUES
(5, 'Ian Arango Rincon', 49.9, '[{\"id\": 2, \"imagen\": \"cafe_02\", \"nombre\": \"Café Frio con Chocolate Grande\", \"precio\": 49.9, \"cantidad\": 1}]', '1686996967986', 0);
